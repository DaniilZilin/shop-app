    ...
    <div>
      <Form
        ...
        <form onSubmit={handleSubmit} className={styles.mainBlock}>
          <Field ref={cardNumberRef} name="cardNumber" component={Input} label="Номер карты" parse={cardNumber} width={300} height={50} maxLength={23}/>
          <div className={styles.lowerContainer}>
            ...
            <Field name="cvcCode" ref={codeRef} component={Input} label="CVC/CVV-код" parse={cvcCode} width={150} height={50} maxLength={3}/>
          </div>
